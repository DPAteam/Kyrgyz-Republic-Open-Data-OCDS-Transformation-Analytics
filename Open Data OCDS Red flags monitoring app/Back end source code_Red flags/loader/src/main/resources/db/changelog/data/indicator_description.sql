...
WHERE id = 5;
UPDATE indicator
SET description = 'Слишком низкий уровень конкуренции. Конкуренция в конкурсе на 30% ниже, чем в среднем по данному спв в данном регионе.',
    ...
    description_kg = 'Атаандаштык деңгээли абдан төмөн. Конкурстагы атаандаштык, ошол региондогу спв маалыматтары боюнча орточо, 30%дан төмөн.'
WHERE id = 6;
UPDATE indicator
