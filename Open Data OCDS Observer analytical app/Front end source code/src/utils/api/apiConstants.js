...
// export const BASE_URL = 'http://212.98.171.10:1027/api/belarus-analytics/v1/'
// export const BASE_URL = 'http://192.168.88.72:9200/api/belarus-analytics/v1/'
export const BASE_URL = 'http://212.98.171.10/api/belarus-analytics/v1/'
// export const BASE_URL = 'http://94.130.140.109:1212/'

//NEW APIs
export const EXPLORATION_API_URI = 'http://94.130.140.109:1212/exploration'
export const INDICATORS_API_URI = 'http://94.130.140.109:1212/indicators'
export const STATISTIC_API_URI = 'http://94.130.140.109:1212/statistic'
export const EXPORT_CSV_API_URI = 'http://94.130.140.109:1212/export/csv'
export const EXPORT_JSON_API_URI = 'http://94.130.140.109:1212/export/json'
export const INTERNATIONAL_API_URI = 'http://94.130.140.109:1212/international-participation'
export const BUY_KYRGYZSTAN_DATA_API_URI = 'http://94.130.140.109:1212/plans'
export const WHAT_TO_BUY_REGIONS_API_URI = 'http://94.130.140.109:1212/whats-buy'
export const TRANSLATION_I18N_API_URI = 'http://94.130.140.109:1212/i18n'
