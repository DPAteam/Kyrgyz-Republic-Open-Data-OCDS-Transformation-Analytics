...
const initialState = {
  ...
  buyKyrgyzstanData: {},
  buyKyrgyzstanDataIsFetching: false,
  buyKyrgyzstanDataErrorMessage: null,
}
...
const buyBelarusianState = (state = initialState, action) => {
  switch (action.type) {
    ...
    case Type.GET_BUY_KYRGYZSTAN_DATA_REQUEST:
      return {
        ...state,
        buyKyrgyzstanDataIsFetching: true,
        buyKyrgyzstanDataErrorMessage: null,
      }

    case Type.GET_BUY_KYRGYZSTAN_DATA_SUCCESS:
      return {
        ...state,
        buyKyrgyzstanData: action.payload,
        buyKyrgyzstanDataIsFetching: false,
      }

    case Type.GET_BUY_KYRGYZSTAN_DATA_FAILURE:
      return {
        ...state,
        buyKyrgyzstanDataIsFetching: false,
        buyKyrgyzstanDataErrorMessage: action.errorMessage,
      }

    case Type.GET_BUY_KYRGYZSTAN_DATA_CLEAR:
      return {
        ...state,
        buyKyrgyzstanData: {},
      }
