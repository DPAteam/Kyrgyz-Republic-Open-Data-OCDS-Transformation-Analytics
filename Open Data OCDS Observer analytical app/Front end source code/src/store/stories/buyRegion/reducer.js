...
const initialState = {
  ...
  whatBuyRegionsData: {},
  whatBuyRegionsDataIsFetching: false,
  whatBuyRegionsDataErrorMessage: null,
}
...
const buyRegionState = (state = initialState, action) => {
  switch (action.type) {
    ...
    case Type.WHAT_TO_BUY_REGIONS_REQUEST:
      return {
        ...state,
        whatBuyRegionsDataIsFetching: true,
        whatBuyRegionsDataErrorMessage: null,
      }

    case Type.WHAT_TO_BUY_REGIONS_SUCCESS:
      return {
        ...state,
        whatBuyRegionsData: action.payload,
        whatBuyRegionsDataIsFetching: false,
      }

    case Type.WHAT_TO_BUY_REGIONS_FAILURE:
      return {
        ...state,
        whatBuyRegionsDataIsFetching: false,
        whatBuyRegionsDataErrorMessage: action.errorMessage,
      }

    case Type.WHAT_TO_BUY_REGIONS_CLEAR:
      return {
        ...state,
        whatBuyRegionsData: {},
      }
