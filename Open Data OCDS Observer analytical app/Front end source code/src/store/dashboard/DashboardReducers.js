...
const dashboardInitialState = {
  ...
  translationI18nData: [],
  translationI18nDataIsFetching: false,
  translationI18nDataErrorMessage: null,
...
const dashboard = (state = dashboardInitialState, action) => {
  switch (action.type) {
    ...
    case Types.GET_TRANSLATIONS_I18N_REQUEST:
      return {
        ...state,
        translationI18nDataIsFetching: true,
        translationI18nDataErrorMessage: null,
      }
    case Types.GET_TRANSLATIONS_I18N_SUCCESS:
      return {
        ...state,
        translationI18nDataIsFetching: false,
        translationI18nData: action.payload,
      }
    case Types.GET_TRANSLATIONS_I18N_FAILURE:
      return {
        ...state,
        translationI18nDataIsFetching: false,
        translationI18nDataErrorMessage: action.errorMessage,
      }
    case Types.GET_TRANSLATIONS_I18N_CLEAR:
      return {
        ...state,
        translationI18nDataIsFetching: false,
        translationI18nData: [],
