...
export const getI18nTranslation = () => {
  const TYPES = [
    Types.GET_TRANSLATIONS_I18N_REQUEST,
    Types.GET_TRANSLATIONS_I18N_SUCCESS,
    Types.GET_TRANSLATIONS_I18N_FAILURE
  ]
  return get(API.TRANSLATION_I18N_API_URI, TYPES)
}
